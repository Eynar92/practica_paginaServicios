                ...
                <div className="flex-1 max-w-[594px] pt-32">
                    ...
                    <ul className="flex flex-col items-start gap-9">
                        ...
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Soluçōes de empréstimos e renegociação para organizar suas finanças.</p>
                        </li>
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            <div className="w-7 h-7 flex items-center justify-center">
                                <Image
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Diversas opçōes de investimentos, de acordo com o seu perfil de investidor.</p>
                        </li>
